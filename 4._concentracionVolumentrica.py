...
#LENGUAJE            : Python                          
#PROGRAMA            : concentracion volumetrica - suspensión               
#FECHA               : 30/06/2020 DD/MM/AA             
...
#cv_ppm=cv*10**6      #concentracion volumentrica en partes por millon cpp
#cv_mgl=10**3*pw*G*cv #concentracion volumentrica adimensional mg/L
#cw_mgl=G*cw_ppm/(G+(1-G)*10**(-6)*cw_ppm)# concreto en peso mg/L
